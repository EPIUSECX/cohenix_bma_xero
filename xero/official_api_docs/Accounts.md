...
Use the DELETE method to delete Accounts. System accounts, accounts used on transactions and accounts linked to other systems like Fixed Assets or Payment Services cannot be deleted using the delete method. If an account is not able to be deleted you can update the status to ARCHIVED
